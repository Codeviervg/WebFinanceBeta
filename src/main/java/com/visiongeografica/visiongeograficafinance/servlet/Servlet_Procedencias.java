 ...
 * @author Henrry
 */
public class Servlet_Procedencias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            listaProcedencia=Procedencia.listarProcedencias(procedencias);            
            RequestDispatcher dispatcher = request.getRequestDispatcher("/User_procedencias.jsp");
            request.setAttribute("lista", listaProcedencia);

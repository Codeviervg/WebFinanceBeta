 ...
 * @author Henrry
 */
public class Servlet_Proyecto_Nuevo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String fecha_proyecto = request.getParameter("fecha_proyecto");
        String id_user = (String) request.getSession().getAttribute("id_user");
        Proyecto p= new Proyecto();
        p.setNombre_proyecto(nombre_proyecto);
        p.setDescripcion(descripcion_proyecto);
        p.setFecha_inicio(fecha_proyecto);
        Coneccion cone= new Coneccion();
        PrintWriter out = response.getWriter();
        boolean resp=cone.Insert_Proyectos(p, id_user);
        if (resp) {
        ...
        out.println("<th ><strong>FIN</strong></th>");
        ...
        for (Proyecto pro : listaProyectos) {
            ...
            out.println("<td style=\"text-align: justify;\">" + pro.getFecha_terminado() + "</td>");

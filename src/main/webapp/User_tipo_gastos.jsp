...
<html>
    <head>
        ...
        <link href="css/tabla_resposive_tipos_gastos.css" rel="stylesheet" type="text/css"/>
    </head>
    <body id="body-pd">
                ...
                <div >
                    ...
                    <div class="container-fluid" id="mainBody">
                        <div class="row" id="container">
                            ...
                            <form action="action">
                                <br/>
                                <h5>Todos los tipos</h5>
                                <label>Buscar: </label>
                                <input id="searchTerm" type="text" onkeyup="doSearch()" />
                                <br>
                                <br>
                                <div id="div1" style="max-height:  600px;">
                                    <table id="datos" class="width200" width="100%">
                                        <thead >                                                                                       
                                            <tr>
                                        ...
                                        <c:forEach var="Objeto" items="${lista}">
                                            <tr>
                                                <td  style="text-align: justify;" ><c:out value="${Objeto.id_tipo_gasto}"/></td>
